...
# Rolls two dice and return total and whether we
# had a double roll
def two_rolls(who):
    double_score = "no"
    ...
    print(f"{who}: {roll_1} & {roll_1} - Total: {first_points}")
...
while user_score < target_score and comp_score < target_score:
    ...
    if double_points == "yes":
        print(f"If you win this round, you gain double points!")
    ...
    # If the user wins, and its points to its score
    elif user_points > computer_points:
